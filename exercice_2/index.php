...
if(!empty($_POST)){
	...
	if(count($errors ?? null) == 0) {
	    ...
	    $insertUser->bindValue('gender', $post['gender'] ?? null);
	    $insertUser->bindValue('firstname', $post['firstname'] ?? null);
	    $insertUser->bindValue('lastname', $post['lastname'] ?? null);
	    $insertUser->bindValue('email', $post['email'] ?? null);
	    $insertUser->bindValue('birthdate', date('Y-m-d', strtotime($post['birthdate'] ?? null)));
	    $insertUser->bindValue('city', $post['city'] ?? null);
